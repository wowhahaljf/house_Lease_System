...
<div class="layui-carousel" id="bg-item">
    <div class="layui-header title">
        <div class="layui-container">
            <div class="layui-logo layui-pull-left">
                <img src="/static/img/logo1.png" width="120px" height="50px">
            </div>
    ...
    <div carousel-item>
        <div style="background: url('/static/img/house1.jpg')no-repeat center/cover"></div>
        <div style="background: url('/static/img/house2.jpg')no-repeat center/cover"></div>
        <div style="background: url('/static/img/house3.jpg')no-repeat center/cover"></div>
        <div style="background: url('/static/img/house4.jpg')no-repeat center/cover"></div>
    </div>
</div>
...
<section class="layui-container">
    <hr>
    <h2>共找到<span style="color: #ffc601;margin: 10px 5px;">${House.size()}</span>套出租房源</h2>
